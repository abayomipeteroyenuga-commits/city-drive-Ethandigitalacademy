...
export const VEHICLES = [
  {
    id: 'metro_s', name: 'G-Wagon', manufacturer: 'Mercedes-Benz', type: VEHICLE_TYPES.SUV, tier: VEHICLE_TIERS.STARTER, price: 0,
    ...
    color: 0x1f3b2d, secondaryColor: 0x0b1210, description: 'Iconic luxury 4x4 starter SUV with a tall boxy stance, upright front and commanding road presence.', seats: 5, isMotorcycle: false, fourWheels: true, streetTraffic: true
  },
  {
    id: 'urban_lx', name: 'S-Class', manufacturer: 'Mercedes-Benz', type: VEHICLE_TYPES.CAR, tier: VEHICLE_TIERS.BEGINNER, price: 18500,
  ...
  {
    id: 'falcon_sport', name: '296 GTB', manufacturer: 'Ferrari', type: VEHICLE_TYPES.CAR, tier: VEHICLE_TIERS.ADVANCED, price: 48500,
    ...
    color: 0xcc202b, secondaryColor: 0x1b0508, description: 'Italian mid-engine supercar with sharp acceleration and precise high-speed control.', seats: 2, isMotorcycle: false, fourWheels: true, streetTraffic: true
  },
  {
    id: 'titan_muscle', name: 'Mustang GT', manufacturer: 'Ford', type: VEHICLE_TYPES.CAR, tier: VEHICLE_TIERS.PREMIUM, price: 62000,
    ...
    color: 0x1d4ed8, secondaryColor: 0x0a1024, description: 'Bold V8-style muscle coupe with explosive acceleration and a wide stance.', seats: 4, isMotorcycle: false, fourWheels: true, streetTraffic: true
  },
  {
    id: 'royal_executive', name: 'Bentayga', manufacturer: 'Bentley', type: VEHICLE_TYPES.SUV, tier: VEHICLE_TIERS.PREMIUM, price: 89000,
  ...
  {
    id: 'vortex_x', name: 'SF90 Stradale', manufacturer: 'Ferrari', type: VEHICLE_TYPES.CAR, tier: VEHICLE_TIERS.ELITE, price: 185000,
    ...
    color: 0xd90018, secondaryColor: 0x220006, description: 'Extreme Ferrari performance with supercar acceleration, grip and braking.', seats: 2, isMotorcycle: false, fourWheels: true, streetTraffic: true
  },
  {
    id: 'city_explorer', name: 'Defender', manufacturer: 'Land Rover', type: VEHICLE_TYPES.SUV, tier: VEHICLE_TIERS.INTERMEDIATE, price: 27500,
  ...
  {
    id: 'grand_terrain', name: 'Range Rover', manufacturer: 'Range Rover', type: VEHICLE_TYPES.SUV, tier: VEHICLE_TIERS.ADVANCED, price: 72000,
  ...
  {
    id: 'mountain_beast', name: 'Wrangler Rubicon', manufacturer: 'Jeep', type: VEHICLE_TYPES.SUV, tier: VEHICLE_TIERS.ADVANCED, price: 58000,
  ...
  {
    id: 'street_hawk', name: 'M4 Competition', manufacturer: 'BMW', type: VEHICLE_TYPES.CAR, tier: VEHICLE_TIERS.BEGINNER, price: 54000,
  ...
  {
    id: 'thunder_r', name: '911 Carrera', manufacturer: 'Porsche', type: VEHICLE_TYPES.CAR, tier: VEHICLE_TIERS.ADVANCED, price: 78000,
    ...
    color: 0xffd21c, secondaryColor: 0x111315, description: 'Iconic rear-engine sports car with agile cornering and exhilarating acceleration.', seats: 4, isMotorcycle: false, fourWheels: true, streetTraffic: true
  },
  {
    id: 'dirt_runner', name: 'Urus', manufacturer: 'Lamborghini', type: VEHICLE_TYPES.SUV, tier: VEHICLE_TIERS.PREMIUM, price: 118000,
  ...
  {
    id: 'cargo_king', name: 'Hilux GR Sport', manufacturer: 'Toyota', type: VEHICLE_TYPES.COMMERCIAL, tier: VEHICLE_TIERS.INTERMEDIATE, price: 36000,
  ...
  {
    id: 'city_van', name: 'Sprinter', manufacturer: 'Mercedes-Benz', type: VEHICLE_TYPES.COMMERCIAL, tier: VEHICLE_TIERS.INTERMEDIATE, price: 42000,
  ...
  {
    id: 'metro_bus', name: 'RS 7 Sportback', manufacturer: 'Audi', type: VEHICLE_TYPES.CAR, tier: VEHICLE_TIERS.ELITE, price: 112000,
