...
function open(){
 ...
 el.innerHTML=`<div class="front-shell">
   ...
   <div class="front-car" aria-hidden="true">
     ...
     <img class="front-gwagon-photo" src="assets/gwagon-white.jpg" alt="Mercedes-Benz G-Wagon"/>
   </div>
